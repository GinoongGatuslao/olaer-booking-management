...
Volt::route('/cashier/bookings/create', 'cashier.bookings.create')
    ->middleware(['auth', 'active', 'role:Cashier'])
    ->name('cashier.bookings.create');
...
Volt::route('/booking/success', 'guest.bookings.success')
    ->name('guest.bookings.success');
