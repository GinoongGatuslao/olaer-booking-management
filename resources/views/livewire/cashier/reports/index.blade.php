...
new #[Layout('layouts.app')] #[Title('Cashier Reports - Olaer Spring Resort')] class extends Component
{
    ...
    private function buildReport(ReportsService $service): array
    {
        ...
        return match ($this->reportType) {
            'revenue' => $service->revenueReport($this->startDate, $this->endDate, (int) Auth::id()),
...
<div class="space-y-6">
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">Cashier Reports</h1>
            <p class="text-sm text-zinc-600 dark:text-zinc-400">Generate and print cashier operational reports.</p>
        </div>
